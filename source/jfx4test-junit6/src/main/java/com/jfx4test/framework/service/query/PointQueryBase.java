 ...
 */
public abstract class PointQueryBase implements com.jfx4test.framework.service.query.PointQuery {
    ...
    @Override
    public com.jfx4test.framework.service.query.PointQuery atPosition(Point2D position) {
        this.position = position;
        return this;
    }

    @Override
    public com.jfx4test.framework.service.query.PointQuery atPosition(double positionX, double positionY) {
        return atPosition(new Point2D(positionX, positionY));
    }

    @Override
    public com.jfx4test.framework.service.query.PointQuery atPosition(Pos position) {
        return atPosition(PointQueryUtils.computePositionFactors(position));
    }

    @Override
    public com.jfx4test.framework.service.query.PointQuery atOffset(Point2D offset) {
        this.offset = new Point2D(this.offset.getX() + offset.getX(), this.offset.getY() + offset.getY());
        return this;
    }

    @Override
    public com.jfx4test.framework.service.query.PointQuery atOffset(double offsetX, double offsetY) {
