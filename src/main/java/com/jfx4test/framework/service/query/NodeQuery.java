...
import com.jfx4test.framework.service.query.EmptyNodeQueryException;
...
public class NodeQuery {
    ...
    public NodeQuery lookupById(String query) {
        lookup(new NodeIdPredicate(query));
        return this;
    }
    ...
    @SuppressWarnings("unchecked")
    public Optional<Node> query() {
        if (parentNodes.isEmpty()) {
            return Optional.empty();
        } else {
            return Optional.of(parentNodes.iterator().next());
        }
    }
