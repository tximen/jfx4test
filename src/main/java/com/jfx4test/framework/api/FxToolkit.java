...
public final class FxToolkit {
    ...
    private static final Logger LOGGER = Logger.getLogger("com.jfx4test.framework.api.FxToolkit");

    private static final ApplicationLauncher APP_LAUNCHER = new ApplicationLauncher();
    private static final ApplicationService APP_SERVICE = new ApplicationService();
    private static final FxToolkitContext CONTEXT = new FxToolkitContext();
    private static final ToolkitService SERVICE = new ToolkitService();
    ...
    /**
     * Sets up the {@link com.jfx4test.framework.toolkit.PrimaryStageApplication} to use in tests, prevents it from shutting
    ...
    public static Stage registerPrimaryStage() throws TimeoutException {
        try {
            ...
            LOGGER.log(Level.SEVERE, exception, () -> "registerPrimaryStage failed");
    ...
    /**
     * Runs on the {@code JavaFX Application Thread}: Hides all windows returned from Windows
    */
    public static void cleanupStages() throws TimeoutException {
        setupFixture(FxToolkit::hideWindows);
    }
    ...
    private static void handleCommonRuntimeExceptions(RuntimeException exception) {
